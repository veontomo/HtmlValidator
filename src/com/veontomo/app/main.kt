...
fun main(args: Array<String>) {
    val fileName = "d:\\Users\\Andrey\\Documents\\projects\\editor\\repository\\manual\\Venditori\\2016_06_08_Venditori_Renault\\20160608a.html";

    val ascii = AsciiValidator();
    File(fileName).forEachLine {
        println(ascii.isValid(it))
    };
...
//    val ascii = com.veontomo.app.AsciiValidator(text);
//    print(ascii.isValid());
//    print(doc.charset());
}
